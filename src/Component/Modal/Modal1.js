...
const Modal1 = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://64da5313e947d30a260b20a6.mockapi.io/Assignment");
  ...
  const handleFormSubmit = async () => {
    try {
      ...
      await axios.post("https://64da5313e947d30a260b20a6.mockapi.io/Assignment", newFormData);
